...
class Plugin(Base):
    ...
    status = Column(SQLAlchemyEnum(PluginStatus), default=PluginStatus.ACTIVE)
    visibility = Column(SQLAlchemyEnum(PluginVisibility), default=PluginVisibility.PRIVATE)
